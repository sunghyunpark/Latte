    ...
    public void InitView(){
        ...
        follow_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                my_article_btn.setTextColor(getResources().getColor(R.color.GrayColor));
                follow_btn.setTextColor(getResources().getColor(R.color.BlackColor));
                follow_underbar.setBackgroundColor(Color.BLACK);
                my_article_underbar.setBackgroundColor(getResources().getColor(R.color.white));
            }
        });
        my_article_btn = (Button)v.findViewById(R.id.my_article_btn);
        my_article_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mViewPager.setCurrentItem(1);
                follow_btn.setTextColor(getResources().getColor(R.color.GrayColor));
                my_article_btn.setTextColor(getResources().getColor(R.color.BlackColor));
                follow_underbar.setBackgroundColor(getResources().getColor(R.color.white));
                my_article_underbar.setBackgroundColor(Color.BLACK);
            }
        });
